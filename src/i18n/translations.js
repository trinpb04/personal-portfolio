  ...
  en: {
    ...
    impact: {
      ...
      metrics: [
        ...
        { value: 8.4, suffix: '/10', label: 'Bachelor GPA', sub: 'Applied Finance & Fintech, UEH–ISB / WSU' },
      ],
  ...
  vi: {
    ...
    impact: {
      ...
      metrics: [
        ...
        { value: 8.4, suffix: '/10', label: 'GPA Cử nhân', sub: 'Tài chính Ứng dụng & Fintech, UEH–ISB / WSU' },
      ],
